...
namespace Consumer.EmployeeService {
    ...
    public interface ICreateEmployeeService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Consumer.EmployeeService.FaultExceptionContract), Action="http://tempuri.org/ICreateEmployeeService/CreateEmployeeFaultExceptionContractFau" +
            "lt", Name="FaultExceptionContract", Namespace="http://schemas.datacontract.org/2004/07/EmployeeService")]
        string CreateEmployee(Consumer.EmployeeService.Employee employee);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICreateEmployeeService/CreateEmployee", ReplyAction="http://tempuri.org/ICreateEmployeeService/CreateEmployeeResponse")]
        System.Threading.Tasks.Task<string> CreateEmployeeAsync(Consumer.EmployeeService.Employee employee);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICreateEmployeeServiceChannel : Consumer.EmployeeService.ICreateEmployeeService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CreateEmployeeServiceClient : System.ServiceModel.ClientBase<Consumer.EmployeeService.ICreateEmployeeService>, Consumer.EmployeeService.ICreateEmployeeService {
        ...
        public string CreateEmployee(Consumer.EmployeeService.Employee employee) {
            return base.Channel.CreateEmployee(employee);
        }
        
        public System.Threading.Tasks.Task<string> CreateEmployeeAsync(Consumer.EmployeeService.Employee employee) {
    ...
    public interface IRetrieveEmployeeService {
        ...
        Consumer.EmployeeService.Employee[] GetEmployees();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRetrieveEmployeeService/GetEmployees", ReplyAction="http://tempuri.org/IRetrieveEmployeeService/GetEmployeesResponse")]
        System.Threading.Tasks.Task<Consumer.EmployeeService.Employee[]> GetEmployeesAsync();
        ...
        Consumer.EmployeeService.Employee[] GetEmployeesByRemark(string remark);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRetrieveEmployeeService/GetEmployeesByRemark", ReplyAction="http://tempuri.org/IRetrieveEmployeeService/GetEmployeesByRemarkResponse")]
        System.Threading.Tasks.Task<Consumer.EmployeeService.Employee[]> GetEmployeesByRemarkAsync(string remark);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRetrieveEmployeeServiceChannel : Consumer.EmployeeService.IRetrieveEmployeeService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RetrieveEmployeeServiceClient : System.ServiceModel.ClientBase<Consumer.EmployeeService.IRetrieveEmployeeService>, Consumer.EmployeeService.IRetrieveEmployeeService {
        ...
        public Consumer.EmployeeService.Employee[] GetEmployees() {
            return base.Channel.GetEmployees();
        }
        
        public System.Threading.Tasks.Task<Consumer.EmployeeService.Employee[]> GetEmployeesAsync() {
        ...
        public Consumer.EmployeeService.Employee[] GetEmployeesByRemark(string remark) {
            return base.Channel.GetEmployeesByRemark(remark);
        }
        
        public System.Threading.Tasks.Task<Consumer.EmployeeService.Employee[]> GetEmployeesByRemarkAsync(string remark) {
